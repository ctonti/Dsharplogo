...
export const animations: AnimationDefinition[] = [
  ...
  },
  {
    ...
    keyframes: [
      ...
      { time: 0.8, rotation: { x: 0, y: 360, z: 0 }, offsetY: -70, color: '#eab308' },
      { time: 0.85, rotation: { x: 0, y: 360, z: 0 }, offsetY: -80, color: '#22c55e' },
      { time: 0.95, rotation: { x: 0, y: 360, z: 0 }, offsetY: -10, color: '#10b981' },
