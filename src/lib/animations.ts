...
export const animations: AnimationDefinition[] = [
  ...
  },
  {
    ...
    keyframes: [
      ...
      { time: 0.05, rotation: { x: 25.7, y: 0, z: 0 }, offsetY: 0, color: '#4472f4' },
      { time: 0.1, rotation: { x: 51.4, y: 0, z: 0 }, offsetY: 0, color: '#4a5ef1' },
      { time: 0.15, rotation: { x: 77.1, y: 0, z: 0 }, offsetY: 0, color: '#5653ee' },
      { time: 0.2, rotation: { x: 102.9, y: 0, z: 0 }, offsetY: 0, color: '#6b51ec' },
      { time: 0.25, rotation: { x: 128.6, y: 0, z: 0 }, offsetY: 0, color: '#8656ee' },
      { time: 0.3, rotation: { x: 154.3, y: 0, z: 0 }, offsetY: 0, color: '#a158f2' },
      { time: 0.35, rotation: { x: 180, y: 0, z: 0 }, offsetY: 0, color: '#bd57f6' },
      { time: 0.4, rotation: { x: 205.7, y: 0, z: 0 }, offsetY: 0, color: '#d954f0' },
      { time: 0.45, rotation: { x: 231.4, y: 0, z: 0 }, offsetY: 0, color: '#ee4ddb' },
      { time: 0.5, rotation: { x: 257.1, y: 0, z: 0 }, offsetY: 0, color: '#f94cb1' },
      { time: 0.55, rotation: { x: 282.9, y: 0, z: 0 }, offsetY: 0, color: '#fa4f87' },
      { time: 0.6, rotation: { x: 308.6, y: 0, z: 0 }, offsetY: 0, color: '#f95f5f' },
      { time: 0.65, rotation: { x: 334.3, y: 0, z: 0 }, offsetY: 0, color: '#f8753f' },
      { time: 0.7, rotation: { x: 360, y: 0, z: 0 }, offsetY: 0, color: '#f97316' },
      { time: 0.8, rotation: { x: 360, y: 0, z: 90 }, offsetY: -70, color: '#f97316' },
      { time: 0.85, rotation: { x: 360, y: 0, z: 180 }, offsetY: -80, color: '#ff8800' },
      { time: 0.95, rotation: { x: 360, y: 0, z: 270 }, offsetY: -10, color: '#ff8800' },
      { time: 1.0, rotation: { x: 360, y: 0, z: 360 }, offsetY: 0, color: '#f97316' },
    ],
    sound: {
      type: 'oscillator',
      frequency: 523,
