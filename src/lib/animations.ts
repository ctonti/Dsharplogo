...
export const animations: AnimationDefinition[] = [
  ...
  },
  {
    ...
    keyframes: [
      ...
      { time: 0.05, rotation: { x: 0, y: 25.7, z: 0 }, offsetY: 0, color: '#4472f4' },
      { time: 0.1, rotation: { x: 0, y: 51.4, z: 0 }, offsetY: 0, color: '#4a5ef1' },
      { time: 0.15, rotation: { x: 0, y: 77.1, z: 0 }, offsetY: 0, color: '#5653ee' },
      { time: 0.2, rotation: { x: 0, y: 102.9, z: 0 }, offsetY: 0, color: '#6b51ec' },
      { time: 0.25, rotation: { x: 0, y: 128.6, z: 0 }, offsetY: 0, color: '#8656ee' },
      { time: 0.3, rotation: { x: 0, y: 154.3, z: 0 }, offsetY: 0, color: '#a158f2' },
      { time: 0.35, rotation: { x: 0, y: 180, z: 0 }, offsetY: 0, color: '#bd57f6' },
      { time: 0.4, rotation: { x: 0, y: 205.7, z: 0 }, offsetY: 0, color: '#d954f0' },
      { time: 0.45, rotation: { x: 0, y: 231.4, z: 0 }, offsetY: 0, color: '#ee4ddb' },
      { time: 0.5, rotation: { x: 0, y: 257.1, z: 0 }, offsetY: 0, color: '#f94cb1' },
      { time: 0.55, rotation: { x: 0, y: 282.9, z: 0 }, offsetY: 0, color: '#fa4f87' },
      { time: 0.6, rotation: { x: 0, y: 308.6, z: 0 }, offsetY: 0, color: '#f95f5f' },
      { time: 0.65, rotation: { x: 0, y: 334.3, z: 0 }, offsetY: 0, color: '#f8753f' },
      { time: 0.7, rotation: { x: 0, y: 360, z: 0 }, offsetY: 0, color: '#f97316' },
      { time: 0.8, rotation: { x: 0, y: 360, z: 90 }, offsetY: -70, color: '#f97316' },
      { time: 0.85, rotation: { x: 0, y: 360, z: 180 }, offsetY: -80, color: '#ff8800' },
      { time: 0.95, rotation: { x: 0, y: 360, z: 270 }, offsetY: -10, color: '#ff8800' },
      { time: 1.0, rotation: { x: 0, y: 360, z: 360 }, offsetY: 0, color: '#f97316' },
    ],
    sound: {
      type: 'oscillator',
      frequency: 523,
  ...
  },
  {
    ...
    keyframes: [
      ...
      { time: 0.3, rotation: { x: 0, y: 90 }, offsetY: -15 },
      { time: 0.5, rotation: { x: 0, y: 180 }, offsetY: -30 },
      { time: 0.65, rotation: { x: 0, y: 270 }, offsetY: -35 },
      { time: 0.75, rotation: { x: 0, y: 360 }, offsetY: -25 },
      { time: 0.82, rotation: { x: 0, y: 405 }, offsetY: -15 },
      { time: 0.88, rotation: { x: 0, y: 450 }, offsetY: -8 },
      { time: 0.93, rotation: { x: 0, y: 495 }, offsetY: -3 },
      { time: 0.97, rotation: { x: 0, y: 540 }, offsetY: -1 },
      { time: 1.0, rotation: { x: 0, y: 540 }, offsetY: 0 },
    ],
    sound: {
      type: 'oscillator',
      frequency: 350,
