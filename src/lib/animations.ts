...
export const animations: AnimationDefinition[] = [
  ...
  },
  {
    ...
    keyframes: [
      ...
      { time: 0.1, rotation: { x: 0, y: 36, z: 0 }, offsetY: -30, color: '#4f46e5' },
      { time: 0.2, rotation: { x: 0, y: 72, z: 0 }, offsetY: -60, color: '#6366f1' },
      { time: 0.3, rotation: { x: 0, y: 108, z: 0 }, offsetY: -90, color: '#8b5cf6' },
      { time: 0.4, rotation: { x: 0, y: 144, z: 0 }, offsetY: -110, color: '#a855f7' },
      { time: 0.5, rotation: { x: 0, y: 180, z: 0 }, offsetY: -120, color: '#ec4899' },
      { time: 0.6, rotation: { x: 0, y: 216, z: 0 }, offsetY: -110, color: '#f43f5e' },
      { time: 0.7, rotation: { x: 0, y: 252, z: 0 }, offsetY: -90, color: '#f97316' },
      { time: 0.8, rotation: { x: 0, y: 288, z: 0 }, offsetY: -60, color: '#fb923c' },
      { time: 0.85, rotation: { x: 0, y: 324, z: 0 }, offsetY: -30, color: '#eab308' },
      { time: 0.9, rotation: { x: 0, y: 345, z: 0 }, offsetY: -10, color: '#84cc16' },
      { time: 0.95, rotation: { x: 0, y: 360, z: 0 }, offsetY: -5, color: '#22c55e' },
