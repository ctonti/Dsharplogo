...
export const animations: AnimationDefinition[] = [
  ...
  },
  {
    ...
    keyframes: [
      ...
      { time: 0.8, rotation: { x: 0, y: 360, z: 0 }, offsetY: -70, color: '#f97316' },
      { time: 0.85, rotation: { x: 0, y: 360, z: 0 }, offsetY: -80, color: '#ff8800' },
      { time: 0.95, rotation: { x: 0, y: 360, z: 0 }, offsetY: -10, color: '#ff8800' },
      { time: 1.0, rotation: { x: 0, y: 360, z: 0 }, offsetY: 0, color: '#f97316' },
    ],
    sound: {
      type: 'oscillator',
      frequency: 523,
