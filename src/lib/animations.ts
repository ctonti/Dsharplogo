...
export const animations: AnimationDefinition[] = [
  ...
  },
  {
    ...
    keyframes: [
      ...
      { time: 0.05, rotation: { x: 25.7, y: 0, z: 0 }, offsetY: 0, radius: 1.014 },
      { time: 0.1, rotation: { x: 51.4, y: 0, z: 0 }, offsetY: 0, radius: 1.029 },
      { time: 0.15, rotation: { x: 77.1, y: 0, z: 0 }, offsetY: 0, radius: 1.043 },
      { time: 0.2, rotation: { x: 102.9, y: 0, z: 0 }, offsetY: 0, radius: 1.057 },
      { time: 0.25, rotation: { x: 128.6, y: 0, z: 0 }, offsetY: 0, radius: 1.071 },
      { time: 0.3, rotation: { x: 154.3, y: 0, z: 0 }, offsetY: 0, radius: 1.086 },
      { time: 0.35, rotation: { x: 180, y: 0, z: 0 }, offsetY: 0, radius: 1.1 },
      { time: 0.4, rotation: { x: 205.7, y: 0, z: 0 }, offsetY: 0, radius: 1.114 },
      { time: 0.45, rotation: { x: 231.4, y: 0, z: 0 }, offsetY: 0, radius: 1.129 },
      { time: 0.5, rotation: { x: 257.1, y: 0, z: 0 }, offsetY: 0, radius: 1.143 },
      { time: 0.55, rotation: { x: 282.9, y: 0, z: 0 }, offsetY: 0, radius: 1.157 },
      { time: 0.6, rotation: { x: 308.6, y: 0, z: 0 }, offsetY: 0, radius: 1.171 },
      { time: 0.65, rotation: { x: 334.3, y: 0, z: 0 }, offsetY: 0, radius: 1.186 },
      { time: 0.7, rotation: { x: 360, y: 0, z: 0 }, offsetY: 0, radius: 1.2 },
      { time: 0.8, rotation: { x: 360, y: 0, z: 90 }, offsetY: -70, radius: 1.133 },
      { time: 0.85, rotation: { x: 360, y: 0, z: 180 }, offsetY: -80, radius: 1.067 },
      { time: 0.95, rotation: { x: 360, y: 0, z: 270 }, offsetY: -10, radius: 1.017 },
