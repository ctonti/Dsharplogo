...
export const animations: AnimationDefinition[] = [
  ...
  },
  {
    ...
    keyframes: [
      ...
      { time: 0.1, rotation: { x: 0, y: 51, z: 0 }, offsetY: 0, color: '#4f46e5' },
      { time: 0.2, rotation: { x: 0, y: 103, z: 0 }, offsetY: 0, color: '#6366f1' },
      { time: 0.3, rotation: { x: 0, y: 154, z: 0 }, offsetY: 0, color: '#8b5cf6' },
      { time: 0.4, rotation: { x: 0, y: 206, z: 0 }, offsetY: 0, color: '#a855f7' },
      { time: 0.5, rotation: { x: 0, y: 257, z: 0 }, offsetY: 0, color: '#ec4899' },
      { time: 0.6, rotation: { x: 0, y: 309, z: 0 }, offsetY: 0, color: '#f43f5e' },
